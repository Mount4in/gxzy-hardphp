...
*/
use mysql;
create user 'db'@'172.18.0.3' identified by 'db';
grant all privileges on *.* to 'db'@'172.18.0.3' identified by 'db';

create user 'root1'@'localhost' identified by 'db';
grant all privileges on *.* to 'root1'@'localhost' identified by 'db';
flush privileges;
